...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleIndices = { VueExpression: 1, VueExpressionNoFilter: 2 },
      peg$startRuleIndex   = 1,

      peg$consts = [
        function(expression) { return expression; },
        "|",
        peg$literalExpectation("|", false),
        function(head, filter) {
                    return filter;
                },
        function(head, tail) {
                return {
        ...
        function(callee, args) {
            return { type: "VueFilter", name: callee.name, arguments: args };
          },
        function(callee) {
            return { type: "VueFilter", name: callee.name, arguments: [] };
          },
        peg$anyExpectation(),
      ...
      peg$bytecode = [
        peg$decode("%;z/:#;!/1$;z/($8#: #!!)(#'#(\"'#&'#"),
        peg$decode("%;\x93/\x9B#$%;z/J#2!\"\"6!7\"/;$;z/2$;#/)$8$:#$\"& )($'#(#'#(\"'#&'#0T*%;z/J#2!\"\"6!7\"/;$;z/2$;#/)$8$:#$\"& )($'#(#'#(\"'#&'#&/)$8\":$\"\"! )(\"'#&'#"),
        peg$decode(";\x93"),
        peg$decode("%;(/;#;z/2$;\x85/)$8#:%#\"\" )(#'#(\"'#&'#./ &%;(/' 8!:&!! )"),
        peg$decode("1\"\"5!7'"),
        peg$decode("<2)\"\"6)7*._ &2+\"\"6+7,.S &2-\"\"6-7..G &2/\"\"6/70.; &21\"\"6172./ &23\"\"6374.# &;S=.\" 7("),
        peg$decode("45\"\"5!76"),
        peg$decode("<28\"\"6879.M &2:\"\"6:7;.A &2<\"\"6<7=.5 &2>\"\"6>7?.) &2@\"\"6@7A=.\" 77"),
        peg$decode("%%<;.=.##&&!&'#/1#;)/($8\":B\"! )(\"'#&'#"),
        peg$decode("<%;*/9#$;+0#*;+&/)$8\":D\"\"! )(\"'#&'#=.\" 7C"),
        peg$decode(";,.Y &2E\"\"6E7F.M &2G\"\"6G7H.A &%2I\"\"6I7J/1#;H/($8\":K\"! )(\"'#&'#"),
        peg$decode(";*.G &;-.A &;P.; &;R.5 &2L\"\"6L7M.) &2N\"\"6N7O"),
        peg$decode(";M.; &;I.5 &;L./ &;J.) &;K.# &;Q"),
        peg$decode(";O.# &;N"),
        peg$decode(";/./ &;0.) &;2.# &;3"),
        peg$decode(";T.\xB3 &;U.\xAD &;V.\xA7 &;Y.\xA1 &;Z.\x9B &;[.\x95 &;\\.\x8F &;].\x89 &;^.\x83 &;c.} &;d.w &;e.q &;g.k &;i.e &;j._ &;k.Y &;m.S &;p.M &;q.G &;r.A &;t.; &;u.5 &;v./ &;w.) &;x.# &;y"),
        peg$decode(";W.A &;X.; &;_.5 &;`./ &;a.) &;h.# &;o"),
        peg$decode(";2./ &;3.) &;4.# &;>"),
        peg$decode("%;l/& 8!:P! )"),
        peg$decode("%;s/& 8!:Q! ).. &%;b/& 8!:R! )"),
        peg$decode("<%;</C#%<;*.# &;7=.##&&!&'#/($8\":T\"!!)(\"'#&'#.M &%;5/C#%<;*.# &;7=.##&&!&'#/($8\":T\"!!)(\"'#&'#=.\" 7S"),
        peg$decode("%;6/T#2U\"\"6U7V/E$$;70#*;7&/5$;9.\" &\"/'$8$:W$ )($'#(#'#(\"'#&'#.} &%2U\"\"6U7V/K#$;7/&#0#*;7&&&#/5$;9.\" &\"/'$8#:W# )(#'#(\"'#&'#.? &%;6/5#;9.\" &\"/'$8\":W\" )(\"'#&'#"),
        peg$decode("2X\"\"6X7Y.= &%;8/3#$;70#*;7&/#$+\")(\"'#&'#"),
        peg$decode("4Z\"\"5!7["),
        peg$decode("4\\\"\"5!7]"),
        peg$decode("%;:/,#;;/#$+\")(\"'#&'#"),
        peg$decode("3^\"\"5!7_"),
        peg$decode("%4`\"\"5!7a.\" &\"/9#$;7/&#0#*;7&&&#/#$+\")(\"'#&'#"),
        peg$decode("%3b\"\"5\"7c/E#%$;=/&#0#*;=&&&#/\"!&,)/($8\":d\"! )(\"'#&'#"),
        peg$decode("4e\"\"5!7f"),
        peg$decode("<%2h\"\"6h7i/G#$;?0#*;?&/7$2h\"\"6h7i/($8#:j#!!)(#'#(\"'#&'#.W &%2k\"\"6k7l/G#$;@0#*;@&/7$2k\"\"6k7l/($8#:j#!!)(#'#(\"'#&'#=.\" 7g"),
        peg$decode("%%<2h\"\"6h7i./ &2I\"\"6I7J.# &;&=.##&&!&'#/0#;$/'$8\":m\" )(\"'#&'#.G &%2I\"\"6I7J/1#;B/($8\":K\"! )(\"'#&'#.# &;A"),
        peg$decode("%%<2k\"\"6k7l./ &2I\"\"6I7J.# &;&=.##&&!&'#/0#;$/'$8\":m\" )(\"'#&'#.G &%2I\"\"6I7J/1#;B/($8\":K\"! )(\"'#&'#.# &;A"),
        peg$decode("%2I\"\"6I7J/0#;'/'$8\":n\" )(\"'#&'#"),
        peg$decode(";C.X &%2X\"\"6X7Y/<#%<;7=.##&&!&'#/'$8\":o\" )(\"'#&'#.) &;G.# &;H"),
        peg$decode(";D.# &;E"),
        peg$decode("2k\"\"6k7l.\xBF &2h\"\"6h7i.\xB3 &2I\"\"6I7J.\xA7 &%2p\"\"6p7q/& 8!:r! ).\x90 &%2s\"\"6s7t/& 8!:u! ).y &%2v\"\"6v7w/& 8!:x! ).b &%2y\"\"6y7z/& 8!:{! ).K &%2|\"\"6|7}/& 8!:~! ).4 &%2\x7F\"\"6\x7F7\x80/& 8!:\x81! )"),
        peg$decode("%%<;F.# &;&=.##&&!&'#/0#;$/'$8\":m\" )(\"'#&'#"),
        peg$decode(";D.; &;7.5 &2\x82\"\"6\x827\x83.) &2\x84\"\"6\x847\x85"),
        peg$decode("%2\x82\"\"6\x827\x83/K#%%;=/,#;=/#$+\")(\"'#&'#/\"!&,)/($8\":\x86\"! )(\"'#&'#"),
        peg$decode("%2\x84\"\"6\x847\x85/]#%%;=/>#;=/5$;=/,$;=/#$+$)($'#(#'#(\"'#&'#/\"!&,)/($8\":\x86\"! )(\"'#&'#"),
        ...
        peg$decode("%2\xA9\"\"6\xA97\xAA/8#%<;+=.##&&!&'#/#$+\")(\"'#&'#"),
        peg$decode("%2\xAB\"\"6\xAB7\xAC/8#%<;+=.##&&!&'#/#$+\")(\"'#&'#"),
        peg$decode("%2\xAD\"\"6\xAD7\xAE/8#%<;+=.##&&!&'#/#$+\")(\"'#&'#"),
        peg$decode("%2\xAF\"\"6\xAF7\xB0/8#%<;+=.##&&!&'#/#$+\")(\"'#&'#"),
        ...
        peg$decode("$;%.# &;'0)*;%.# &;'&"),
        peg$decode("$;%0#*;%&"),
        peg$decode(";(.t &;1.n &;}.h &;\x80.b &%2\xE9\"\"6\xE97\xEA/R#;z/I$;\x93/@$;z/7$2\xEB\"\"6\xEB7\xEC/($8%: %!\")(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%2\xED\"\"6\xED7\xEE/a#;z/X$%;\x7F/,#;z/#$+\")(\"'#&'#.\" &\"/7$2\xEF\"\"6\xEF7\xF0/($8$:\xF1$!!)($'#(#'#(\"'#&'#.\xE1 &%2\xED\"\"6\xED7\xEE/R#;z/I$;~/@$;z/7$2\xEF\"\"6\xEF7\xF0/($8%:\xF2%!\")(%'#($'#(#'#(\"'#&'#.\x9C &%2\xED\"\"6\xED7\xEE/\x8C#;z/\x83$;~/z$;z/q$2\xF3\"\"6\xF37\xF4/b$;z/Y$%;\x7F/,#;z/#$+\")(\"'#&'#.\" &\"/8$2\xEF\"\"6\xEF7\xF0/)$8(:\xF5(\"%!)(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%%%;\x7F/,#;z/#$+\")(\"'#&'#.\" &\"/2#;\x93/)$8\":\xF6\"\"! )(\"'#&'#/\xDF#$%;z/l#2\xF3\"\"6\xF37\xF4/]$;z/T$%;\x7F/,#;z/#$+\")(\"'#&'#.\" &\"/3$;\x93/*$8%:\xF7%#'! )(%'#($'#(#'#(\"'#&'#0v*%;z/l#2\xF3\"\"6\xF37\xF4/]$;z/T$%;\x7F/,#;z/#$+\")(\"'#&'#.\" &\"/3$;\x93/*$8%:\xF7%#'! )(%'#($'#(#'#(\"'#&'#&/)$8\":\xF8\"\"! )(\"'#&'#"),
        peg$decode("%2\xF3\"\"6\xF37\xF4/j#$%;z/2#2\xF3\"\"6\xF37\xF4/#$+\")(\"'#&'#0<*%;z/2#2\xF3\"\"6\xF37\xF4/#$+\")(\"'#&'#&/($8\":\xF9\"! )(\"'#&'#"),
        peg$decode("%2\xFA\"\"6\xFA7\xFB/?#;z/6$2\xFC\"\"6\xFC7\xFD/'$8#:\xFE# )(#'#(\"'#&'#.\xBF &%2\xFA\"\"6\xFA7\xFB/R#;z/I$;\x81/@$;z/7$2\xFC\"\"6\xFC7\xFD/($8%:\xFF%!\")(%'#($'#(#'#(\"'#&'#.z &%2\xFA\"\"6\xFA7\xFB/j#;z/a$;\x81/X$;z/O$2\xF3\"\"6\xF37\xF4/@$;z/7$2\xFC\"\"6\xFC7\xFD/($8':\xFF'!$)(''#(&'#(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%;\x82/\x8F#$%;z/D#2\xF3\"\"6\xF37\xF4/5$;z/,$;\x82/#$+$)($'#(#'#(\"'#&'#0N*%;z/D#2\xF3\"\"6\xF37\xF4/5$;z/,$;\x82/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0100\"\"! )(\"'#&'#"),
        peg$decode("%;\x83/S#;z/J$2\u0101\"\"6\u01017\u0102/;$;z/2$;\x93/)$8%:\u0103%\"$ )(%'#($'#(#'#(\"'#&'#"),
        peg$decode(";).) &;>.# &;4"),
        peg$decode("%;|/\u0139#$%;z/b#2\xED\"\"6\xED7\xEE/S$;z/J$;\x93/A$;z/8$2\xEF\"\"6\xEF7\xF0/)$8&:\u0104&\"(\")(&'#(%'#($'#(#'#(\"'#&'#.T &%;z/J#2U\"\"6U7V/;$;z/2$;)/)$8$:\u0105$\"& )($'#(#'#(\"'#&'#0\xA3*%;z/b#2\xED\"\"6\xED7\xEE/S$;z/J$;\x93/A$;z/8$2\xEF\"\"6\xEF7\xF0/)$8&:\u0104&\"(\")(&'#(%'#($'#(#'#(\"'#&'#.T &%;z/J#2U\"\"6U7V/;$;z/2$;)/)$8$:\u0105$\"& )($'#(#'#(\"'#&'#&/)$8\":\u0106\"\"! )(\"'#&'#"),
        peg$decode("%2\xE9\"\"6\xE97\xEA/a#;z/X$%;\x86/,#;z/#$+\")(\"'#&'#.\" &\"/7$2\xEB\"\"6\xEB7\xEC/($8$:\u0107$!!)($'#(#'#(\"'#&'#"),
        peg$decode("%;\x93/\x8F#$%;z/D#2\xF3\"\"6\xF37\xF4/5$;z/,$;\x93/#$+$)($'#(#'#(\"'#&'#0N*%;z/D#2\xF3\"\"6\xF37\xF4/5$;z/,$;\x93/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0100\"\"! )(\"'#&'#"),
        peg$decode("%;\x84/\x83#$%;z/>#;\x88/5$;z/,$;\x84/#$+$)($'#(#'#(\"'#&'#0H*%;z/>#;\x88/5$;z/,$;\x84/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0108\"\"! )(\"'#&'#"),
        peg$decode("%%2\u0109\"\"6\u01097\u010A/>#%<2\u010B\"\"6\u010B7\u010C=.##&&!&'#/#$+\")(\"'#&'#/\"!&,).\x8D &%%2\u010D\"\"6\u010D7\u010E/>#%<2\u010B\"\"6\u010B7\u010C=.##&&!&'#/#$+\")(\"'#&'#/\"!&,).U &%%2\u010F\"\"6\u010F7\u0110/>#%<2\u010B\"\"6\u010B7\u010C=.##&&!&'#/#$+\")(\"'#&'#/\"!&,)"),
        peg$decode("%;\x87/\x83#$%;z/>#;\x8A/5$;z/,$;\x87/#$+$)($'#(#'#(\"'#&'#0H*%;z/>#;\x8A/5$;z/,$;\x87/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0108\"\"! )(\"'#&'#"),
        peg$decode("%%2\u0111\"\"6\u01117\u0112/>#%<4\u0113\"\"5!7\u0114=.##&&!&'#/#$+\")(\"'#&'#/\"!&,).U &%%2\u0115\"\"6\u01157\u0116/>#%<4\u0117\"\"5!7\u0118=.##&&!&'#/#$+\")(\"'#&'#/\"!&,)"),
        peg$decode("%;\x89/\x83#$%;z/>#;\x8C/5$;z/,$;\x89/#$+$)($'#(#'#(\"'#&'#0H*%;z/>#;\x8C/5$;z/,$;\x89/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0108\"\"! )(\"'#&'#"),
        peg$decode("2\u0119\"\"6\u01197\u011A.\x99 &2\u011B\"\"6\u011B7\u011C.\x8D &%%2\u011D\"\"6\u011D7\u011E/>#%<2\u011D\"\"6\u011D7\u011E=.##&&!&'#/#$+\")(\"'#&'#/\"!&,).U &%%2\u011F\"\"6\u011F7\u0120/>#%<2\u011F\"\"6\u011F7\u0120=.##&&!&'#/#$+\")(\"'#&'#/\"!&,)"),
        peg$decode("%;\x8B/\x83#$%;z/>#;\x8E/5$;z/,$;\x8B/#$+$)($'#(#'#(\"'#&'#0H*%;z/>#;\x8E/5$;z/,$;\x8B/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0108\"\"! )(\"'#&'#"),
        peg$decode("2\u0121\"\"6\u01217\u0122.A &2\u0123\"\"6\u01237\u0124.5 &2\u0125\"\"6\u01257\u0126.) &2\u0127\"\"6\u01277\u0128"),
        peg$decode("%;\x8D/\x83#$%;z/>#;\x90/5$;z/,$;\x8D/#$+$)($'#(#'#(\"'#&'#0H*%;z/>#;\x90/5$;z/,$;\x8D/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0129\"\"! )(\"'#&'#"),
        peg$decode("2\u012A\"\"6\u012A7\u012B"),
        peg$decode("%;\x8F/\x83#$%;z/>#;\x92/5$;z/,$;\x8F/#$+$)($'#(#'#(\"'#&'#0H*%;z/>#;\x92/5$;z/,$;\x8F/#$+$)($'#(#'#(\"'#&'#&/)$8\":\u0129\"\"! )(\"'#&'#"),
        peg$decode("2\u012C\"\"6\u012C7\u012D"),
        peg$decode("%;\x91/~#;z/u$2\u012E\"\"6\u012E7\u012F/f$;z/]$;\x93/T$;z/K$2\u0101\"\"6\u01017\u0102/<$;z/3$;\x93/*$8):\u0130)#($ )()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#.# &;\x91")
      ],
